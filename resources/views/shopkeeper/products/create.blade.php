                    ...
                    <form action="{{ route('shopkeeper.products.store') }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="image_url" class="block mt-1 w-full" type="url" name="image_url" :value="old('image_url')" required />
                            ...
                            <div>
                                ...
                                <x-text-input id="discount_price" class="block mt-1 w-full" type="number" step="0.01" name="discount_price" :value="old('discount_price')" />
